...
[Configuring ODBC Connections for Linux and Mac OS X](https://cwiki.apache.org
/confluence/display/DRILL/Configuring+ODBC+Connections+for+Linux+and+Mac+OS+X)
.
